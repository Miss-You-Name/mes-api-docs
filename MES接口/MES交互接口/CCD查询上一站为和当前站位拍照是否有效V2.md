...
module: MES交互接口
method: POST
test_url: "http://10\.200\.6\.54:10002/StationService\.asmx?op=ML\_SS\_CheckCCDStationV2"
prod_url: "http://10.200.6.27:10002/fundation/api/online-mes/v2/transfer/ml/ss/checkccdstationv2"
---

# CCD查询上一站为和当前站位拍照是否有效V2

> **模块**: [[00-总览|MES接口]] > [[MES交互接口/MES交互接口-概览|MES交互接口]]
> **方式**: POST
> **测试**: `http://10\.200\.6\.54:10002/StationService\.asmx?op=ML\_SS\_CheckCCDStationV2`
> **正式**: `http://10.200.6.27:10002/fundation/api/online-mes/v2/transfer/ml/ss/checkccdstationv2`
...
`http://10.200.6.27:10002/fundation/api/online-mes/v2/transfer/ml/ss/checkccdstationv2`

对应的Webservice地址

http://10.200.6.54:10002/StationService.asmx?op=ML_SS_CheckCCDStationV2
