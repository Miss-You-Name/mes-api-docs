...
module: 车灯v3相关接口
method: POST
test_url: "http://10\.200\.6\.200:10002/fundation/api/device/unbind/move/pallet"
prod_url: "http://10\.200\.6\.27:10002/fundation/api/device/unbind/move/pallet"
---

# 流动工装托盘绑定关系解绑接口（环线使用流动的托盘）

> **模块**: [[00-总览|MES接口]] > [[车灯v3相关接口/车灯v3相关接口-概览|车灯v3相关接口]]
> **方式**: POST
> **测试**: `http://10\.200\.6\.200:10002/fundation/api/device/unbind/move/pallet`
> **正式**: `http://10\.200\.6\.27:10002/fundation/api/device/unbind/move/pallet`
...
COM_Device_DeviceUnbindMovePallet
