...
module: 车灯v3相关接口
method: POST
test_url: "http://10\.200\.6\.200:10002/fundation/api/device/check/control"
prod_url: "http://10\.200\.6\.27:10002/fundation/api/device/check/control"
---
...
> **方式**: POST
> **测试**: `http://10\.200\.6\.200:10002/fundation/api/device/check/control`
> **正式**: `http://10\.200\.6\.27:10002/fundation/api/device/check/control`
...
|station|是|String|站位|通过线体、站位字段接口会适配不同的管控逻辑|
|line|是|String|线体|通过线体、站位字段接口会适配不同的管控逻辑|
